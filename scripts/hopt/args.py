...
def parse_hopt_args() -> dict:
  ...
  parser.add_argument("-c", help="clear hyperopt", action="store_true")
  ...
  parser.add_argument("-lo", help="choose sharpe or sortino", type=str)
  ...
  parser.add_argument("-cv", help="load CV trials instead of optimized trials", action="store_true")
  parser.add_argument("-lie", help="lie strategy", default="cl_min")
  parser.add_argument("-pts", help="number of initial points", default=-1)
