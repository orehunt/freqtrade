...
def parse_hopt_args() -> dict:
  ...
  parser.add_argument("-mx", help="max number of trials per worker before logging", type=int, default=None)
  parser.add_argument("-tm", help="max number of seconds before logging by each worker", type=int, default=None)
  ...
  parser.add_argument("-lo", help="loss function, if split the first part is for trials instance", type=str)
  ...
  parser.add_argument("-k", help="how many parmaters groups to eval in one run", type=int, default=0)
