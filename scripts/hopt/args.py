...
def parse_hopt_args() -> dict:
    ...
    parser.add_argument("-path", help="specify a path to a file or directory", default="", type=str)
    parser.add_argument("-merge", help="specify saved data to be merged as one", default=False, action="store_true")
