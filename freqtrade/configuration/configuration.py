...
class Configuration:
    ...
    def _process_datadir_options(self, config: Dict[str, Any]) -> None:
        ...
        if self.args.get("exportfilename"):
            ...
            config["exportfilename"] = (
                config["user_data_dir"] / "backtest_results/backtest-result.json"
            )
    ...
    def _process_optimize_options(self, config: Dict[str, Any]) -> None:
        ...
        self._args_to_config(
            config,
            argname="effort",
            logstring="Parameter --effort detected ... " "Parameter --effort detected: {}",
        )
        self._args_to_config(config, argname="mode", logstring="Hyperopt will run in {} mode ...")
        self._args_to_config(
            config, argname="explore", logstring="Acquisition strategy set to random {}..."
        )
        self._args_to_config(
            config, argname="ask_points", logstring="Optimizers will be asked for {} points..."
        )
        self._args_to_config(
